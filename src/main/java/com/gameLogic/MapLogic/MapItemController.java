        ...
        try{
            ...
            while (reader.hasNext()) {
                ...
                if(healingData.size() == 2){
                    healingItems.put((int)Math.floor(Math.random()*mapSize[0]) + "." +  (int)Math.floor(Math.random()*mapSize[1])
                            ,new HealingItem(healingData.get(0), Integer.parseInt(healingData.get(1))));
                } else {
